<%@ Page Title="Brides Stories" Language="C#" MasterPageFile="~/Views/_layout.Master" AutoEventWireup="true" CodeBehind="BridesStories.aspx.cs" Inherits="HaiDen.Views.BridesStories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <section class="container content-page signup-page pagelist">
        <div class="page-head">
            <div class="logo">
