<%@ Page Title="Privacy Policy" Language="C#" MasterPageFile="~/Views/_layout.Master" AutoEventWireup="true" CodeBehind="PrivacyPolicy.aspx.cs" Inherits="HaiDen.Views.PrivacyPolicy" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Footer" runat="server">
    <script>
        $(document).ready(function () {
            ...
            InfoPrivacy_Script.initPrivacy();
        });
    </script>
</asp:Content>
