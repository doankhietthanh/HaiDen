<%@ Page Title="About Us" Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="About_Us.aspx.cs" Inherits="HaiDen.Admin.About_Us" %>
                    ...
                    <div class="col-sm-6">
                        <form id="frm">
                            ...
                            <div class="form-group">
                                <label>Tên </label>
                                <div class="fg-line">
                                    <input type="text" class="form-control iname" required placeholder="Tên">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Tiêu đề </label>
                                <div class="fg-line">
                                    <input type="text" class="form-control ititle" required placeholder="Tiêu đề ">
                                </div>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var reload_key = 0;
        var path = '../Assets/HinhAnh/AboutUs/';
        ...
        function load_about() {
            ...
            param = { "stpe": 45, "shoplistSt": shoplistSt };
            postAjax(param, load_about_result, "html");
        }

        function load_about_result(e) {
            if (e != "err") {
                if (reload_key == 1) {
                ...
                var grid = $("#data-table-command").bootgrid({
                    ...
                    grid.find(".cmd-edit").on("click", function (e) {
                        ...
                        $('.modal-title').html('Sửa New Số: ' + id);
        ...
        function insert_update_about() {
            ...
            var shoplistSt = escape(JSON.stringify(Shoplist));
            var param = { "stpe": 46, "shoplistSt": shoplistSt };
            postAjax(param, insert_update_about_result, "html");
        }
        function insert_update_about_result(e) {
            if (e != 'err') {
                reload_key = 1;
                reload();
        ...
        function delete_about_id(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    var Shoplist = [{ "id": id }];
                    var shoplistSt = escape(JSON.stringify(Shoplist));
                    var param = { "stpe": 47, "shoplistSt": shoplistSt };
        ...
        function load_about_id(id) {

            var Shoplist = [{ "id": id }];
            var shoplistSt = escape(JSON.stringify(Shoplist));
            var param = { "stpe": 14, "shoplistSt": shoplistSt };
            postAjax_list(param, load_about_id_result, "html");
        }
        function load_about_id_result(e) {

            for (var i in e) {
                var dr = e[0];
                var
                    name = $('.iname').val(dr.name),
                    title = $('.ititle').val(dr.title),
                    id = $('.iid').val(dr.id);
