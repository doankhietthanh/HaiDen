<%@ Page Title="FAQ " Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="FAQS.aspx.cs" Inherits="HaiDen.Admin.FAQS" %>
        ...
        <table id="data-table-command" class="table table-striped table-vmiddle">
            <thead>
                <tr>
                    ...
                    <th data-column-id="ques" data-order="desc">Câu hỏi</th>
                    <th data-column-id="ans" data-order="desc">Câu trả lời</th>
                    <th data-column-id="cate" data-order="desc">Danh mục FAQ </th>
                    <th data-column-id="commands" data-formatter="commands" data-sortable="false">Action</th>
                </tr>
            </thead>
            <tbody class="list_faq">
                <tr>
                    <td></td>
                </tr>
            </tbody>
                    ...
                    <div class="col-sm-12">
                        <form id="frm">
                            <div class="form-group">
                                <label>Câu hỏi </label>
                                <div class="fg-line">
                                    <textarea class="form-control auto-size iques" placeholder="Nhập Câu hỏi ..."> </textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="fg-line">
                                    ...
                                    <textarea class="form-control auto-size ians" placeholder="Nhập Câu trả lời ..."> </textarea>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function load_faq() {
            ...
            param = { "stpe": 21, "shoplistSt": shoplistSt };
            postAjax(param, load_faq_result, "html");
        }

        function load_faq_result(e) {
            if (e != "err") {
                if (reload_key == 1) {
                ...
                var grid = $("#data-table-command").bootgrid({
                    ...
                    grid.find(".cmd-edit").on("click", function (e) {
                        ...
                        $('.modal-title').html('Sửa FAQ Số: ' + id);
        ...
        function load_list_cate() {
            ...
            var Shoplist = [{}];
            var shoplistSt = escape(JSON.stringify(Shoplist));
            var param = { "stpe": 24, "shoplistSt": shoplistSt };
        ...
        function insert_update_faq() {
            ...
            var shoplistSt = escape(JSON.stringify(Shoplist));
            var param = { "stpe": 22, "shoplistSt": shoplistSt };
            postAjax(param, insert_update_faq_result, "html");
        }
        function insert_update_faq_result(e) {
            if (e != 'err') {
                reload_key = 1;
                reload();
        ...
        function delete_faq_id(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    var Shoplist = [{ "id": id }];
                    var shoplistSt = escape(JSON.stringify(Shoplist));
                    var param = { "stpe": 23, "shoplistSt": shoplistSt };
        ...
        function load_faq_id(id) {

            var Shoplist = [{ "id": id }];
            var shoplistSt = escape(JSON.stringify(Shoplist));
            var param = { "stpe": 8, "shoplistSt": shoplistSt };
            postAjax_list(param, load_faq_id_result, "html");
        }
        function load_faq_id_result(e) {

            for (var i in e) {
                var dr = e[0];
                var
                    ques = $('.iques').val(dr.ques),
                    ans = $('.ians').val(dr.ans),
