<%@ Page Title="Collection " Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="Collections.aspx.cs" Inherits="HaiDen.Admin.Collections" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table id="data-table-command" class="table table-striped table-vmiddle">
            <thead>
                <tr>
                    ...
                    <th data-column-id="ten" data-order="desc">Tên collection </th>
                    <th data-column-id="imagess" data-formatter="pix">Hình ảnh 1</th>
                    <th data-column-id="imagess_1" data-formatter="pix1">Hình ảnh 2</th>
                    <th data-column-id="des" data-order="desc">Mùa </th>
                    <th data-column-id="date" data-order="desc">Mô tả </th>
                    <th data-column-id="commands" data-formatter="commands" data-sortable="false">Action</th>
                </tr>
            </thead>
            <tbody class="list_collection">
                <tr>
                    <td></td>
                </tr>
            </tbody>
    ...
    <div class="card">
        <div class="card-header">
            <h2 class="note">Ghi chú tỷ lệ ảnh</h2>
        </div>
        <div id="data-table-command-header" class="bootgrid-header container-fluid">

            <p>Collection 1: 605px x 900px (cứ nhân theo tỷ lệ này lên là được)</p>

            <p>Collection 2: 1165px x 780px (cứ nhân theo tỷ lệ này lên là được)</p>

            <p>Collection 3: 780px x 1080px (cứ nhân theo tỷ lệ này lên là được)</p>

            <p>Collection 4: 780px x 1080px and Hình thum 2: 500px x 500px (cứ nhân theo tỷ lệ này lên là được)</p>

            <p>Collection 5: 975px x 735px (cứ nhân theo tỷ lệ này lên là được)</p>
                ...
                <div class="modal-body clearfix">
                    ...
                    <div class="col-sm-6">
                        <form id="frm">
                            <div class="form-group">
                                ...
                                <div class="fg-line">
                                    <input type="text" class="form-control iname" required placeholder="Tên collection">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Mùa</label>
                                <div class="fg-line">
                                    <input type="text" class="form-control isea" required placeholder="Mùa">
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="col-sm-3" style="text-align: center;">
                        <div class="form-group fg-float">
                            <a id="UploadButton_APP_LIST" class="btn btn-primary waves-effect">Hình thumb 1</a>
                        </div>
                    ...
                    <div class="col-sm-3" style="text-align: center;">
                        <div class="form-group fg-float">
                            <a id="UploadButton_APP_LIST_1" class="btn btn-primary waves-effect">Hình thumb 2</a>
                        </div>
                        <img class="pimg_APP_LIST_1" src="img/demo/note.png.ashx?width=290&height=250&mode=crop" />
                        <input type="hidden" id="iimg_APP_LIST_1" value="-1" />
                    </div>
    ...
    <script type="text/javascript">
        $('#editorDetail').summernote({
            ...
            callbacks: {
                onImageUpload: function (files) {
                    sendFile(files[0], '#editorcontent');
                }
            },
            ...
            imageAttributes: {
                ...
                removeEmpty: false, // true = remove attributes | false = leave empty if presents
                disableUpload: false // true = don't display Upload Options | Display Upload Options
            }
            //-----------
        });
        var reload_key = 0;
        var path = '../Assets/HinhAnh/Collections/';
        $(document).ready(function () {
            ...
            $('.btn-save').on('click', function () {
                ...
                if (isValid) {
                    insert_update_collection();
                }

            });
            uploadimg('APP_LIST');
            uploadimg('APP_LIST_1');
        ...
        //===================LOAD LIST COLLECTIONS =========================

        function load_collection() {

            var Shoplist = [{}];
            var shoplistSt = escape(JSON.stringify(Shoplist));
            param = { "stpe": 15, "shoplistSt": shoplistSt };
            postAjax(param, load_collection_result, "html");
        }

        function load_collection_result(e) {
            if (e != "err") {
                if (reload_key == 1) {
                    $('#data-table-command').bootgrid("destroy"); reload_key = 0;
                }
                $('.list_collection').html(e);
                var grid = $("#data-table-command").bootgrid({
                    ...
                    formatters: {
                        ...
                        "pix1": function (column, row) {
                            return "<img src=" + path + row.imagess_1 + "\" />";
                    ...
                    grid.find(".cmd-edit").on("click", function (e) {
                        ...
                        $('.modal-title').html('Sửa Collection Số: ' + id);
        ...
        function insert_update_collection() {

            var name = $('.iname').val(),
                des = $('.ides').val(),
                sea = $('.isea').val(),
                img = $('#iimg_APP_LIST').val(),
                img1 = $('#iimg_APP_LIST_1').val(),
                id = $('.iid').val();
            ...
            var Shoplist = [{
                ...
                "sea": sea,
                "iimg_APP_LIST": img,
                "iimg_APP_LIST_1": img1,
            }];

            var shoplistSt = escape(JSON.stringify(Shoplist));
            var param = { "stpe": 16, "shoplistSt": shoplistSt };
            postAjax(param, insert_update_collection_result, "html");
        }
        function insert_update_collection_result(e) {
            if (e != 'err') {
                reload_key = 1;
                reload();
        ...
        function reset() {
            ...
            img1 = $('#iimg_APP_LIST_1').val('-1');
            $('.pimg_APP_LIST_1').attr('src', 'img/demo/note.png.ashx?width=290&height=250&mode=crop');
        ...
        //===================DELETE COLLECTIONS ============================
        function delete_collection_id(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    var Shoplist = [{ "id": id }];
                    var shoplistSt = escape(JSON.stringify(Shoplist));
                    var param = { "stpe": 17, "shoplistSt": shoplistSt };
        ...
        function load_collection_id(id) {

            var Shoplist = [{ "id": id }];
            var shoplistSt = escape(JSON.stringify(Shoplist));
            var param = { "stpe": 6, "shoplistSt": shoplistSt };
            postAjax_list(param, load_collection_id_result, "html");
        }
        function load_collection_id_result(e) {
            ...
            for (var i in e) {
                ...
                $('#iimg_APP_LIST_1').val(dr.img1),
                    $('.pimg_APP_LIST_1').attr('src', path + dr.img1 + '.ashx?width=290&height=250&mode=crop');
            }
        }
        //==================UPLOAD IMG========================
