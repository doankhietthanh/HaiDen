<%@ Page Title="News" Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="News.aspx.cs" Inherits="HaiDen.Admin.News" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function load_news() {
            ...
            param = { "stpe": 12, "shoplistSt": shoplistSt };
            postAjax(param, load_news_result, "html");
        }

        function load_news_result(e) {
            if (e != "err") {
                if (reload_key == 1) {
        ...
        function insert_update_news() {
            ...
            postAjax(param, insert_update_news_result, "html");
        }
        function insert_update_news_result(e) {
            if (e != 'err') {
                reload_key = 1;
                reload();
        ...
        function load_news_id(id) {

            var Shoplist = [{ "id": id }];
            var shoplistSt = escape(JSON.stringify(Shoplist));
            var param = { "stpe": 5, "shoplistSt": shoplistSt };
            postAjax_list(param, load_news_id_result, "html");
        }
        function load_news_id_result(e) {
